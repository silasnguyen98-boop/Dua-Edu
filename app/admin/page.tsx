                      ...
                      <article className="class-dashboard-panel">
                        ...
                        <div style={{ display: "flex", alignItems: "flex-end", gap: "12px", height: "100px", marginTop: "16px", padding: "0 10px" }}>
                          {(() => {
                            ...
                            return range.map((n) => {
                              const r = classDashboardMetrics.sessionRows.find(sr => sr.sessionNumber === n);
                              if (!r) return null;
            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: "550px", padding: "0", borderRadius: "20px", overflow: "hidden" }}>
              ...
              <div style={{ padding: "30px", display: "grid", gap: "24px" }}>
                <div style={{ padding: "20px", borderRadius: "16px", background: "#f0fdf4", border: "1px solid #dcfce7" }}>
                  ...
                  <ul style={{ margin: 0, paddingLeft: "20px", fontSize: "14px", color: "#14532d", lineHeight: "1.8" }}>
                    <li>Điểm chuyên cần: <strong>≥ 4.0</strong></li>
              ...
              <div style={{ padding: "20px 30px", background: "#f8fafc", textAlign: "right" }}>
                <button className="primary-button" onClick={() => setShowCertGuide(false)}>Đã hiểu</button>
              </div>
            </div>
          </div>
        )}
