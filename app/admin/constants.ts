...
export const tableConfigs: TableConfig[] = [
  ...
  },
  {
    ...
    searchFields: ["class_name", "class_code", "schedule", "study_time", "meeting_url", "recording_url"],
    fields: [
      {
        name: "course_id",
        label: "Khoá học",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "attendance_score", label: "Điểm chuyên cần", type: "number", step: "0.01" },
      { name: "note", label: "Ghi chú", type: "textarea" },
    ],
  },
  {
  ...
  },
  {
    ...
    searchFields: ["session_title", "note"],
    fields: [
      {
        name: "class_id",
        label: "Lớp học",
